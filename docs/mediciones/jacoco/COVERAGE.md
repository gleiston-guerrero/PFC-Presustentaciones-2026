...
**Reporte crudo archivado (XML + CSV):** [`docs/mediciones/jacoco/2026-09-15-cobertura-global-70/`](2026-09-15-cobertura-global-70/) — **cifra de cierre vigente**, corrida con `make test` sobre Postgres/Redis reales en Docker (**801 tests / 0 fallos / 0 errores**, 87 clases). [`2026-09-13-cobertura-controladores/`](2026-09-13-cobertura-controladores/), [`2026-09-11-cierre-limpio/`](2026-09-11-cierre-limpio/), [`2026-09-11-controllers-70/`](2026-09-11-controllers-70/), [`2026-09-11-fase1-must/`](2026-09-11-fase1-must/), [`2026-09-06-servicios/`](2026-09-06-servicios/), [`2026-09-05-cierre/`](2026-09-05-cierre/) y `2026-09-05/` son corridas previas; `2026-08-30/`, `2026-08-29/` y `2026-08-17/` se conservan como snapshots históricos. El reporte también se regenera y publica como artefacto en el job `backend` de [`.github/workflows/ci.yml`](../../../.github/workflows/ci.yml) en cada push.

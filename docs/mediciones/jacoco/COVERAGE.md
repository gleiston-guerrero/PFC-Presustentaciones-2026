...
**⚠️ Actualización (2026-09-19, cifra de cierre definitiva):** la revisión del 18-sep encontró
conviviendo en los documentos vigentes tres cifras de cobertura distintas (82,10 / 82,03 / 82,96) y tres
...
sola sesión, Postgres/Redis reales en Docker): **804/804 tests, 0 fallos, 0 errores — 82,00 % líneas
(4019/4901) / 73,49 % ramas (1483/2018)**, `jacoco:check` en verde. Reporte crudo versionado en
...
líneas de código que agregaron las correcciones posteriores (4901 instrumentadas en vez de 4897), no un
cambio de método de medición. Para que la desincronización no se repita, `make verify` corre ahora
`scripts/cifras-publicadas.py`, que extrae cada cifra de cobertura y cada conteo de pruebas de los
documentos **vigentes** y los contrasta contra este mismo `jacoco.xml`; si alguien publica un número que
el expediente no respalda, el build falla. Las entradas fechadas de más abajo **no** se reescribieron:
registran lo que era cierto cuando se escribieron, y corregirlas retroactivamente sería falsear la
bitácora.
...
**Reporte crudo archivado (XML + CSV):** [`docs/mediciones/jacoco/2026-09-19-cierre-definitivo/`](2026-09-19-cierre-definitivo/) — **cifra de cierre vigente** (82,00 %/73,49 %), corrida limpia de una sola sesión con `mvn clean test` sobre Postgres/Redis reales en Docker (**804 tests / 0 fallos / 0 errores**), `jacoco:check` en verde. [`2026-09-18-corrida-limpia-reproduccion/`](2026-09-18-corrida-limpia-reproduccion/) y [`2026-09-17-corrida-limpia-unica-sesion/`](2026-09-17-corrida-limpia-unica-sesion/) son las dos corridas limpias previas (82,03 %/73,49 % sobre 4897 líneas), [`2026-09-17-cierre-examen-suspenso/`](2026-09-17-cierre-examen-suspenso/) (misma cifra en la práctica, pero acumulaba 71 sesiones de ejecución), [`2026-09-15-cobertura-global-70/`](2026-09-15-cobertura-global-70/) (801 tests, misma cifra en la práctica), [`2026-09-13-cobertura-controladores/`](2026-09-13-cobertura-controladores/), [`2026-09-11-cierre-limpio/`](2026-09-11-cierre-limpio/), [`2026-09-11-controllers-70/`](2026-09-11-controllers-70/), [`2026-09-11-fase1-must/`](2026-09-11-fase1-must/), [`2026-09-06-servicios/`](2026-09-06-servicios/), [`2026-09-05-cierre/`](2026-09-05-cierre/) y `2026-09-05/` son corridas previas; `2026-08-30/`, `2026-08-29/` y `2026-08-17/` se conservan como snapshots históricos. El reporte también se regenera y publica como artefacto en el job `backend` de [`.github/workflows/ci.yml`](../../../.github/workflows/ci.yml) en cada push.

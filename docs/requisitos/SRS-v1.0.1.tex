...
\textbf{Repositorio:} & \url{https://github.com/gleiston-guerrero/PFC-Presustentaciones-2026} \\
...
ninguna ruta--- con 207 combinaciones de método y ruta, 10 rutinas SQL por nombre (7 procedimientos
y 3 funciones; el esquema materializado real tiene 13 objetos ---8 \texttt{PROCEDURE} y 5
\texttt{FUNCTION}--- porque 3 nombres conservan una sobrecarga adicional sin uso desde una fusión de
ramas de agosto de 2026, ver \texttt{docs/basedatos/CATALOGO-SP.md}), 31 migraciones
...
\texttt{RedisDegradationTest.java}, doble de \texttt{StringRedisTemplate} que lanza
...
(\cd{CleanupLogScheduler}, \cd{@Scheduled} mensual, retención de 2 años) sin ningún
...
(3) Procedimiento de supresión (\cd{ErasureDataService}) que \textbf{seudonimiza}, no borra: el
...
(construcción, contenedores, migraciones, las 559 pruebas de la etiqueta \texttt{v1.0.1}, carga,
auditoría, reportes y compilación del informe), y las imágenes están ancladas por resumen. El tercer criterio no se cumple.}
...
\begin{enumerate}
    \item \textbf{La cobertura de pruebas.} La especificación anterior declaraba 38,88\,\% de líneas y
          ...
          era otra, y la del punto de corte (etiqueta \texttt{v1.0.1}, 2026-09-06) es de
          \textbf{81,03\,\%} de líneas con 559 pruebas.

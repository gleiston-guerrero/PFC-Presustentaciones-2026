...
Este proyecto no involucró experimentación clínica ni recolección de datos personales identificables. La
única recolección con participantes humanos fue el instrumento SUS (Sección~\ref{sec:evaluacion}): 15
respuestas anónimas, de las cuales 4 con fecha de aplicación verificable sostienen el resultado
reportado, según lo declarado más arriba en esta misma sección. El protocolo de consentimiento informado
está documentado en \texttt{docs/etica/consentimientos/plantilla-consentimiento.md}; el formulario
aplicado llevaba la nota impresa de consentimiento, no una hoja firmada individualmente, y esa
limitación queda declarada aquí en vez de subsanarse retroactivamente. Se

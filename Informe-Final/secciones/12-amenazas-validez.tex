...
tarea (tiempo para completar un flujo). Además, de las 15 respuestas recolectadas solo 4 tienen fecha de
aplicación verificable (Sección~\ref{sec:evaluacion}): el resultado reportado ($n=4$) es una muestra
pequeña, insuficiente para generalizar con confianza más allá de este grupo.
...
parcialmente cerrada: de las 15 respuestas recolectadas, únicamente 4 tienen fecha de aplicación
verificable (Sección~\ref{sec:evaluacion}).

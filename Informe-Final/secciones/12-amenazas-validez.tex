...
grupo, y sus participantes no son los mismos de la ronda en papel. A eso se suma una amenaza de
constructo propia del instrumento tal como se aplicó aquí: su consistencia interna es
$\alpha = 0.599$, por debajo del 0.85--0.92 habitual en el SUS, de modo que los diez ítems no se
comportan como una sola dimensión y el puntaje agregado pierde parte de su interpretabilidad

...
Usabilidad & Instrumento SUS \cite{brooke1996}, ronda del 18-sep con fecha sellada por un tercero:
\textbf{media 52.83/100} ($n=15$), por debajo del promedio de la industria (68) --- resultado
desfavorable, reportado como tal. De la ronda anterior en papel solo 4 de 15 hojas tenían fecha de
aplicación verificable; las otras 11 quedan retractadas y declaradas pendientes de confirmar, no
descartadas (Sección~\ref{sec:evaluacion}). \\
Fiabilidad & 823 pruebas automatizadas reales (0 fallos), \texttt{/actuator/health} como verificación de

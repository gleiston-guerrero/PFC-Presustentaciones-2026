...
(Figura~\ref{fig:sus-comparacion}). Que una muestra distinta, independiente y con
fecha verificable caiga en el mismo rango es evidencia \emph{indirecta} de que los puntajes de las hojas
no son cifras inventadas para quedar bien; no dice nada sobre su fecha, y se presenta con ese límite.

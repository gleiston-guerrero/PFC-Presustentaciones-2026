...
Instrumento SUS \cite{brooke1996} de diez ítems, aplicado el 2026-09-17 a \textbf{15 participantes reales}
del sistema (6 estudiantes, 4 docentes, 3 coordinadores, 2 administradores), de forma anónima y con
consentimiento informado impreso en el propio formulario. Las 15 respuestas crudas están versionadas en
\texttt{docs/mediciones/sus/sus-respuestas.csv}, con las 15 hojas escaneadas originales como evidencia en
\texttt{docs/mediciones/sus/respuestas-crudas/}. Puntaje calculado con la fórmula estándar de Brooke y
verificado con \texttt{Python} (\texttt{statistics}/\texttt{scipy}) directamente sobre el CSV:
\textbf{media 55.17/100, desviación estándar 12.55, intervalo de confianza 95\,\% [48.22, 62.12]}
($n=15$). Según la escala de interpretación de Bangor et al. (2009), un promedio de 55.17 cae en la banda
``OK''/marginal, por debajo del umbral de 68 que se considera por encima del promedio en la literatura
SUS --- se reporta la cifra real sin maquillar, ninguna respuesta fue inventada ni ajustada. Una versión
anterior de este proyecto afirmaba un puntaje con evaluadores inexistentes --- esos datos eran fabricados
y fueron retirados explícitamente (detalle en \texttt{docs/mediciones/sus/SUS-RESULTS.md}). El protocolo

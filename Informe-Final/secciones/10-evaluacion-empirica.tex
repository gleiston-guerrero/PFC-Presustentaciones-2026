...
\textbf{Cifra de cierre definitiva (2026-09-17, la que aplica para el umbral del 70\,\%), corrida limpia
de una sola sesión:} \textbf{82.03\,\% de líneas (4,017/4,897) y 73.49\,\% de ramas (1,483/2,018)} a
...
directamente desde
\texttt{docs/mediciones/jacoco/2026-09-17-corrida-limpia-unica-sesion/jacoco.xml} (versionado en el
repositorio). Desde esta misma ronda se agregó además una regla \texttt{jacoco:check} en \texttt{pom.xml}

...
retiradas. Sobre quién entregó materialmente esas hojas, incluida la segunda versión con el mes
...
nivel global, sobre 804 pruebas automatizadas reales (\texttt{mvn clean test} sobre Postgres/Redis reales
...
\textbf{82.01\,\% de líneas (4,022/4,904) y 73.49\,\% de ramas (1,483/2,018)} a nivel global (804
pruebas, 0 fallos).

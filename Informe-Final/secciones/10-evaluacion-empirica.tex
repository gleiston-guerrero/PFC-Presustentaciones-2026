...
anterior de este proyecto afirmaba un puntaje de usabilidad con evaluadores inexistentes --- esos datos eran
fabricados y fueron retirados explícitamente (detalle completo en \texttt{docs/mediciones/sus/SUS-RESULTS.md}).
No se reporta ninguna cifra de usabilidad en este informe

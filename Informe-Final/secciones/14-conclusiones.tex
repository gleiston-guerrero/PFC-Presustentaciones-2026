...
momento (hoy 82.13\,\% global, ver Sección~\ref{sec:evaluacion}) en vez de un ``$>$60\,\%'' previamente afirmado
...
PostgreSQL, los índices en columnas de alto tráfico, y el crecimiento de 109 a 823 pruebas automatizadas
con la cobertura subiendo de 38.88\,\% a 82.13\,\% de líneas) como las acciones concretas y verificables

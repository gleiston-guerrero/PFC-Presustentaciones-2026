...
Maximilien \& Williams \cite{maximilien2003} & TDD y reducción de defectos & ICSE 2003 & Contrasta con la cobertura de 82.13\,\% de líneas de este proyecto (Sección~\ref{sec:evaluacion}); TDD no se practicó formalmente \\
...
Arcuri \cite{arcuri2019} & Generación automática de pruebas REST & ACM TOSEM 2019 & Contraste honesto: las 823 pruebas de este proyecto son manuales (JUnit/Mockito), no generadas por \textit{fuzzing} dirigido por búsqueda como EvoMaster --- una vía real de trabajo futuro para ampliar cobertura de ramas sin más esfuerzo manual \\
\bottomrule
\end{tabular}

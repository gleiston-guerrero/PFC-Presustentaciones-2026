...
código llega a 82.10\,\% de líneas y 73.49\,\% de ramas (801 pruebas, 0 fallos), superando el 70\,\% en ambas métricas de forma global. Una
...
50 Must-priority requirements have a dedicated test (72\,\%), and code coverage reaches 82.10\,\% of
lines and 73.49\,\% of branches (801 tests, 0 failures), exceeding 70\,\% globally in both metrics. A manual review of the

...
código llega a 71.46\,\% de líneas (657 pruebas, 0 fallos), superando el 70\,\% en controladores y servicios. Una
...
50 Must-priority requirements have a dedicated test (72\,\%), and code coverage reaches 71.46\,\% of
lines (657 tests, 0 failures), exceeding 70\,\% in both the controller and service layers. A manual review of the

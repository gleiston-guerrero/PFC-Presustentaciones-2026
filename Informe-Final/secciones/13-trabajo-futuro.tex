...
\begin{enumerate}[nosep]
    ...
    (JaCoCo, 2026-09-20, 823 tests, 0 fallos) da \textbf{82.13\,\%/73.52\,\%} (líneas/ramas) a nivel
    ...
    ramas).
    \item \textbf{Cerrar el origen de las 11 hojas SUS retractadas:} la ronda del 18-sep aportó una
    medición con fecha sellada por un tercero ($n=15$, ver Sección~\ref{sec:evaluacion} y
    \texttt{docs/mediciones/sus/SUS-RESULTS.md}), pero es una muestra nueva: ninguno de esos 15
    participantes declara haber respondido antes en papel. Queda pendiente confirmar con las 11
    personas originales cuándo respondieron realmente, o volver a aplicarles el cuestionario a ellas
    --- es la tarea de integridad más directa entre las listadas aquí.
    ...
    \texttt{PreDefenseApplicationTests} y \texttt{TopicProposedRepositoryIntegrationTest} --- esta

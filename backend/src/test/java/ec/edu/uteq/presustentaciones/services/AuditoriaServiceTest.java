...
/**
 * AuditoriaService no tenia ningun test (0% de ramas) pese a ser el bean que fija el
 * "quien" que ven los triggers de auditoria (V15) en cada escritura auditable.
 */
...
class AuditoriaServiceTest {
    ...
    void fijarEntityManager() {
        ...
        ReflectionTestUtils.setField(auditoriaService, "entityManager", entityManager);
    }
    ...
    void marcarActorActualFijaCadenaVaciaSinAuthenticationEnElContexto() {
        ...
        assertDoesNotThrow(() -> auditoriaService.marcarActorActual());
    ...
    @Test
    void marcarActorActualFijaCadenaVaciaParaUsuarioAnonimo() {
        SecurityContextHolder.getContext().setAuthentication(
    ...
    @Test
    void marcarActorActualFijaElIdDelUsuarioAutenticado() {

...
public class ResourceTitulacionController {

    private final ResourceTitulacionService resourceService;
    ...
    public ResponseEntity<ResourceTitulacionDTO> create(@RequestBody @Valid SaveResourceRequest request) {

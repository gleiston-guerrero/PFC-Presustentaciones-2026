 ...
 * Mismo patrón que {@link StatusSubmission}: id SMALLINT explícito (lo siembra la migración,
...
public class StatusMinutes {
     ...
     *
     * @param code código del estado de minutes
     * @return una instancia con solo el código repoblado (id/nombre quedan null)
     */
    @JsonCreator
    public static StatusMinutes fromCode(String code) {
        return StatusMinutes.builder().code(code).build();
    }
}

...
public class EstadoSubmission {
     ...
     *
     * @param codigo código del estado de submission
     * @return una instancia con solo el código repoblado (id/nombre quedan null)
     */
    @JsonCreator
    public static EstadoSubmission fromCodigo(String codigo) {
        return EstadoSubmission.builder().codigo(codigo).build();
    }
}

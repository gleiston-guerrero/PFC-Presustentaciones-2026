...
| **Usabilidad SUS** | [`docs/mediciones/sus/sus-respuestas.csv`](docs/mediciones/sus/sus-respuestas.csv) | Aplicado a **15 personas reales** (estudiantes, docentes, coordinadores, administradores), anónimo y con consentimiento informado. Media SUS **55,17/100**, DE **12,55**, IC 95% **[48,22, 62,12]** — CSV versionado con las 15 respuestas + puntaje, 15 hojas de evidencia cruda en [`respuestas-crudas/`](docs/mediciones/sus/respuestas-crudas/), detalle en [`SUS-RESULTS.md`](docs/mediciones/sus/SUS-RESULTS.md). |

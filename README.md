...
| **Usabilidad SUS** | [`docs/mediciones/sus/SUS-RESULTS.md`](docs/mediciones/sus/SUS-RESULTS.md) | Aplicado a **15 personas reales** (estudiantes, docentes, coordinadores, administradores), anónimo y con consentimiento informado. Media SUS **55,17/100**, DE **12,55**, IC 95% **[48,22, 62,12]** — 15 hojas de evidencia cruda versionadas en [`respuestas-crudas/`](docs/mediciones/sus/respuestas-crudas/). |

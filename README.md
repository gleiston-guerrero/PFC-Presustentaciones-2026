...
| **DOI del software (Zenodo)** | [`docs/ZENODO.md`](docs/ZENODO.md) / [`docs/ZENODO-DATASET.md`](docs/ZENODO-DATASET.md) | ✅ **Archivado en Zenodo** — versión actual `v1.1.0`: [10.5281/zenodo.22854267](https://doi.org/10.5281/zenodo.22854267) (licencia MIT, 2026-09-20, snapshot del commit `a60ae4c`; el primer snapshot de la misma versión, del 19-sep, es [10.5281/zenodo.22839517](https://doi.org/10.5281/zenodo.22839517) y quedó superado). Versiones anteriores: `v1.0.1` [10.5281/zenodo.22445216](https://doi.org/10.5281/zenodo.22445216) y `v1.0.0` [10.5281/zenodo.21988564](https://doi.org/10.5281/zenodo.21988564). DOI de concepto (siempre resuelve a la última versión): [10.5281/zenodo.21988563](https://doi.org/10.5281/zenodo.21988563). Dataset de mediciones: [10.5281/zenodo.22398713](https://doi.org/10.5281/zenodo.22398713) (CC-BY 4.0, `docs/ZENODO-DATASET.md`). |

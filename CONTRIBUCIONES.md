...
> después ya eran 172. **Por eso la tabla dejó de escribirse y pasó a generarse.**
...
| `jalavaa@uteq.edu.ec` (institucional) | 80 |
...
|---|---|---|---|
| P1 | `f51db75`, `80e1c08`, `70035fa`, `e38cc0d`, `8488d06`, `05a2135`, `5d6102b`, `79b682a`, `d284a22`, `d42da11`, `23ddf41`, `fd38f8d`, `29a684a`, `ff33e15`, `52bf35b`, `4a99a8e`, `d4a740c`, `1e32fa1`, `006f7c1`, `4d1dffe`, `71a8632` | `docs/mediciones/sus/SUS-RESULTS.md`<br>`Informe-Final/secciones/10-evaluacion-empirica.tex`<br>`VERIFICACION.md`<br>`scripts/verify.sh` | 69 |
...
| P9 | `8b1c1d2`, `7c9358b`, `cf686d2`, `22bdcd1`, `394d213`, `546b9bc`, `f065b3c`, `746ee5a`, `87f67c2`, `00cf66b`, `35d8199`, `b2d413d`, `63d1a1e`, `d17deda`, `a0dead6`, `f02c762`, `ab1c922`, `a883cac`, `a60ae4c`, `ecb7b01`, `d5a79cc`, `e8fef9a`, `10a59dc`, `37e6006`, `f944f02`, `eee1571`, `71a8632` | `docs/ZENODO.md`<br>`CONTRIBUCIONES.md`<br>`VERIFICACION.md`<br>`CITATION.cff` | 25 |
...
| EV-1 | `9fd9d0c`, `feb9d64`, `f63e903`, `2275fa6`, `fd38f8d`, `9bafe85`, `d947402`, `e8fef9a`, `f76e826`, `5425c2e` | `VERIFICACION.md`<br>`CONTRIBUCIONES.md`<br>`scripts/verify.sh`<br>`scripts/mutaciones-gate.py` | 17 |
| EV-2 | `9fd9d0c`, `feb9d64`, `20b378a`, `512608e`, `7d3d004`, `ef11139`, `f7bd8c5`, `a920a70`, `3acd7b7`, `b6d5119`, `7ad1854`, `988dc11`, `6290af9`, `2871eb5`, `70e73cc`, `4142a97`, `acffa24`, `cef0bf3`, `28064fd`, `4d1dffe`, `71a8632` | `VERIFICACION.md`<br>`scripts/mutaciones-gate.py`<br>`scripts/verify.sh`<br>`scripts/ev2-documental.py` | 100 |
| EV-4 | `9fd9d0c`, `feb9d64`, `2275fa6`, `512608e`, `1c9c9da`, `142c35f`, `eefc32c`, `ef11139`, `34ffa44`, `ff33e15`, `4a99a8e`, `1e32fa1`, `35d8199`, `63d1a1e`, `a0dead6`, `33cd83e`, `a920a70`, `ab1c922`, `9bafe85`, `d947402`, `5658f49`, `1f60787`, `a60ae4c`, `d5a79cc`, `f76e826`, `2ef7870`, `bd4602c`, `007c0a6`, `60f1022`, `40fd254`, `64dd037`, `5b69ef1`, `f477698`, `fb64f53`, `9d9ca5a`, `ace9dcc`, `038fe35`, `1b6968c`, `6fbb919`, `37e6006`, `4fbca22` | `CONTRIBUCIONES.md`<br>`scripts/ev4-contribuciones.py`<br>`VERIFICACION.md`<br>`scripts/verify.sh` | 48 |
...
### Commits sin punto declarado (9 de 172)
...
| `b0ef5e6` | docs(informe): recompilar el PDF con las correcciones de los puntos 3, 4 y 5 |
...
|---|---|---:|
| Álava Alvarado, Jean Pierre | `Jean30042 <jeanalavaalavarado@gmail.com>` (227), `Jean30042 <jalavaa@uteq.edu.ec>` (80), `jalavaa-dev <jalavaa@uteq.edu.ec>` (1) | 308 |
...
**Total en la historia de `main`: 494 commits.** La suma de la columna es exactamente ese total: cada
...
|---|---|---|---|
| Álava Alvarado, Jean Pierre | `jalavaa@uteq.edu.ec` | Autor de los 172 commits del tramo | ____________________ |

...
> después ya eran 116. **Por eso la tabla dejó de escribirse y pasó a generarse.**
...
| `jalavaa@uteq.edu.ec` (institucional) | 24 |
...
| P5 | `73ec6c7`, `c5434ab`, `2161280`, `cc41724`, `e440644`, `f9c9483`, `006f7c1` | `Informe-Final/secciones/10-evaluacion-empirica.tex`<br>`README.md`<br>`VERIFICACION.md`<br>`docs/mediciones/perf/figuras/fig-lighthouse-scores.png` | 25 |
...
| P9 | `8b1c1d2`, `7c9358b`, `cf686d2`, `22bdcd1`, `394d213`, `546b9bc`, `f065b3c`, `746ee5a`, `87f67c2`, `00cf66b`, `35d8199`, `b2d413d`, `63d1a1e`, `d17deda`, `a0dead6` | `docs/ZENODO.md`<br>`CITATION.cff`<br>`CONTRIBUCIONES.md`<br>`VERIFICACION.md` | 12 |
...
| EV-4 | `9fd9d0c`, `feb9d64`, `2275fa6`, `512608e`, `1c9c9da`, `142c35f`, `eefc32c`, `ef11139`, `34ffa44`, `ff33e15`, `4a99a8e`, `1e32fa1`, `35d8199`, `63d1a1e`, `a0dead6` | `CONTRIBUCIONES.md`<br>`scripts/ev4-contribuciones.py`<br>`Makefile`<br>`VERIFICACION.md` | 45 |
...
### Commits sin punto declarado (8 de 116)
...
|---|---|---|---|
| Álava Alvarado, Jean Pierre | `jalavaa@uteq.edu.ec` | Autor de los 116 commits del tramo | ____________________ |

...
> después ya eran 112. **Por eso la tabla dejó de escribirse y pasó a generarse.**
...
| `jalavaa@uteq.edu.ec` (institucional) | 20 |
...
| P9 | `8b1c1d2`, `7c9358b`, `cf686d2`, `22bdcd1`, `394d213`, `546b9bc`, `f065b3c`, `746ee5a`, `87f67c2`, `00cf66b`, `35d8199`, `b2d413d` | `docs/ZENODO.md`<br>`CITATION.cff`<br>`VERIFICACION.md`<br>`docs/ZENODO-METADATOS-v1.1.0.md` | 12 |
...
| EV-4 | `9fd9d0c`, `feb9d64`, `2275fa6`, `512608e`, `1c9c9da`, `142c35f`, `eefc32c`, `ef11139`, `34ffa44`, `ff33e15`, `4a99a8e`, `1e32fa1`, `35d8199` | `CONTRIBUCIONES.md`<br>`scripts/ev4-contribuciones.py`<br>`Makefile`<br>`VERIFICACION.md` | 45 |
...
### Commits sin punto declarado (8 de 112)
...
|---|---|---|---|
| Álava Alvarado, Jean Pierre | `jalavaa@uteq.edu.ec` | Autor de los 112 commits del tramo | ____________________ |

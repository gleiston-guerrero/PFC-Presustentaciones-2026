...
> después ya eran 169. **Por eso la tabla dejó de escribirse y pasó a generarse.**
...
| `jalavaa@uteq.edu.ec` (institucional) | 77 |
...
|---|---|---|---|
| P1 | `f51db75`, `80e1c08`, `70035fa`, `e38cc0d`, `8488d06`, `05a2135`, `5d6102b`, `79b682a`, `d284a22`, `d42da11`, `23ddf41`, `fd38f8d`, `29a684a`, `ff33e15`, `52bf35b`, `4a99a8e`, `d4a740c`, `1e32fa1`, `006f7c1`, `4d1dffe` | `docs/mediciones/sus/SUS-RESULTS.md`<br>`Informe-Final/secciones/10-evaluacion-empirica.tex`<br>`VERIFICACION.md`<br>`scripts/verify.sh` | 62 |
...
| P9 | `8b1c1d2`, `7c9358b`, `cf686d2`, `22bdcd1`, `394d213`, `546b9bc`, `f065b3c`, `746ee5a`, `87f67c2`, `00cf66b`, `35d8199`, `b2d413d`, `63d1a1e`, `d17deda`, `a0dead6`, `f02c762`, `ab1c922`, `a883cac`, `a60ae4c`, `ecb7b01`, `d5a79cc`, `e8fef9a`, `10a59dc`, `37e6006`, `f944f02` | `docs/ZENODO.md`<br>`CONTRIBUCIONES.md`<br>`VERIFICACION.md`<br>`CITATION.cff` | 13 |
...
| EV-2 | `9fd9d0c`, `feb9d64`, `20b378a`, `512608e`, `7d3d004`, `ef11139`, `f7bd8c5`, `a920a70`, `3acd7b7`, `b6d5119`, `7ad1854`, `988dc11`, `6290af9`, `2871eb5`, `70e73cc`, `4142a97`, `acffa24`, `cef0bf3`, `28064fd`, `4d1dffe` | `VERIFICACION.md`<br>`scripts/mutaciones-gate.py`<br>`scripts/verify.sh`<br>`scripts/ev2-documental.py` | 99 |
...
### Commits sin punto declarado (9 de 169)
...
|---|---|---:|
| Álava Alvarado, Jean Pierre | `Jean30042 <jeanalavaalavarado@gmail.com>` (227), `Jean30042 <jalavaa@uteq.edu.ec>` (77), `jalavaa-dev <jalavaa@uteq.edu.ec>` (1) | 305 |
...
**Total en la historia de `main`: 491 commits.** La suma de la columna es exactamente ese total: cada
...
|---|---|---|---|
| Álava Alvarado, Jean Pierre | `jalavaa@uteq.edu.ec` | Autor de los 169 commits del tramo | ____________________ |

...
> después ya eran 105. **Por eso la tabla dejó de escribirse y pasó a generarse.**
...
| `jalavaa@uteq.edu.ec` (institucional) | 13 |
...
|---|---|---|---|
| P1 | `f51db75`, `80e1c08`, `70035fa`, `e38cc0d`, `8488d06`, `05a2135`, `5d6102b`, `79b682a`, `d284a22`, `d42da11`, `23ddf41`, `fd38f8d`, `29a684a`, `ff33e15`, `52bf35b` | `docs/mediciones/sus/SUS-RESULTS.md`<br>`Informe-Final/secciones/10-evaluacion-empirica.tex`<br>`README.md`<br>`VERIFICACION.md` | 48 |
...
| P8 | `bd2cc84`, `40426b3`, `cd4f770`, `1569635`, `b783e5e`, `93e6806`, `52bf35b` | `docs/mediciones/sec/owasp/scripts/audit-endpoints-autorizacion.py`<br>`Informe-Final/secciones/10-evaluacion-empirica.tex`<br>`VERIFICACION.md`<br>`docs/mediciones/sec/owasp/OWASP-AUDIT.md` | 22 |
...
| P10 | `bd2cc84`, `85c13cf`, `d301e8b`, `9c16cd2`, `dfd93e3`, `e36f25e`, `2275fa6`, `52bf35b` | `Informe-Final/secciones/00-portada.tex`<br>`VERIFICACION.md`<br>`CONTRIBUCIONES.md`<br>`Informe-Final/secciones/10-evaluacion-empirica.tex` | 23 |
...
| EV-4 | `9fd9d0c`, `feb9d64`, `2275fa6`, `512608e`, `1c9c9da`, `142c35f`, `eefc32c`, `ef11139`, `34ffa44`, `ff33e15` | `CONTRIBUCIONES.md`<br>`scripts/ev4-contribuciones.py`<br>`Makefile`<br>`VERIFICACION.md` | 45 |
...
### Commits sin punto declarado (8 de 105)
...
|---|---|---|---|
| Álava Alvarado, Jean Pierre | `jalavaa@uteq.edu.ec` | Autor de los 105 commits del tramo | ____________________ |

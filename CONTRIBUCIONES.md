...
> después ya eran 108. **Por eso la tabla dejó de escribirse y pasó a generarse.**
...
| `jalavaa@uteq.edu.ec` (institucional) | 16 |
...
|---|---|---|---|
| P1 | `f51db75`, `80e1c08`, `70035fa`, `e38cc0d`, `8488d06`, `05a2135`, `5d6102b`, `79b682a`, `d284a22`, `d42da11`, `23ddf41`, `fd38f8d`, `29a684a`, `ff33e15`, `52bf35b`, `4a99a8e`, `d4a740c` | `docs/mediciones/sus/SUS-RESULTS.md`<br>`Informe-Final/secciones/10-evaluacion-empirica.tex`<br>`README.md`<br>`VERIFICACION.md` | 56 |
...
| P7 | `bd2cc84`, `b99bb72`, `c20ce4c`, `d4a740c` | `Informe-Final/secciones/10-evaluacion-empirica.tex`<br>`VERIFICACION.md`<br>`backend/src/test/java/ec/edu/uteq/presustentaciones/controllers/ChatbotControllerIntegrationTest.java`<br>`CONTRIBUTORS.md` | 26 |
...
| P11 | `bd2cc84`, `73771be`, `6282d50`, `53de5be`, `7b7016c`, `7210c75`, `dd3e192`, `95923ea`, `e40718f` | `Informe-Final/secciones/10-evaluacion-empirica.tex`<br>`docs/requisitos/SRS-v1.0.1.tex`<br>`Informe-Final/secciones/08-diseno-arquitectura.tex`<br>`Informe-Final/secciones/13-trabajo-futuro.tex` | 41 |
...
| EV-2 | `9fd9d0c`, `feb9d64`, `20b378a`, `512608e`, `7d3d004`, `ef11139` | `CONTRIBUCIONES.md`<br>`scripts/verify.sh`<br>`.gitignore`<br>`Makefile` | 51 |
| EV-4 | `9fd9d0c`, `feb9d64`, `2275fa6`, `512608e`, `1c9c9da`, `142c35f`, `eefc32c`, `ef11139`, `34ffa44`, `ff33e15`, `4a99a8e` | `CONTRIBUCIONES.md`<br>`scripts/ev4-contribuciones.py`<br>`Makefile`<br>`VERIFICACION.md` | 45 |
...
### Commits sin punto declarado (8 de 108)
...
|---|---|---|---|
| Álava Alvarado, Jean Pierre | `jalavaa@uteq.edu.ec` | Autor de los 108 commits del tramo | ____________________ |
